      ...
      >
        {orbitItems.map((item, i) => (
          ...
          >
            <motion.img
              data-arm-image
              className="rounded-full object-cover absolute left-1/2 top-1/2 aspect-square -translate-x-1/2 bg-white dark:bg-[#2A2520] border-2 border-black/5 dark:border-white/10 shadow-md"
              style={{
                width: imageSize,
                height: imageSize,
                opacity: i === 0 ? 1 : 0,
